        ...
        var r = t("html, body"),
            ...
            s = {
                isExternal: function (t) {
                    var n = t.match(/^([^:\/?#]+:)?(?:\/\/([^\/?#]*))?([^?#]+)?(\?[^#]*)?(#.*)?/);
                    return "string" == typeof n[1] && n[1].length > 0 && n[1].toLowerCase() !== e.location.protocol
                        ? !0
                        : "string" == typeof n[2] && n[2].length > 0 && n[2].replace(new RegExp(":(" + { "http:": 80, "https:": 443 }[e.location.protocol] + ")?$"), "") !== e.location.host;
                },
                ...
                storePageIn: function (e, n, o, r, a, i) {
                    ...
                    return "undefined" == typeof a && (a = {}), "undefined" == typeof i && (i = n), (e[n] = { status: "loaded", title: s.find("title").first().text(), html: s.find("#" + r), doc: o, state: a, destUrl: i }), e;
                },
            ...
            u = function (i, l) {
                var u = t(i),
                    ...
                    S = function (o) {
                        ...
                        s.length
                            ...
                            : !s && l.debug && a
                            ? a.warn("No element with an id of " + i + " in response from " + o + " in " + h)
                            : (e.location = o);
                    },
                    w = function (t, n, o) {
                        var i = s.translate(t);
                            ...
                            g = {
                                loaded: function () {
                                    ...
                                    if (
                                        ...
                                        (p = l.alterChangeState({ id: c }, h[i.url].title, r)), (h[i.url].state = p), e.history.pushState(p, h[i.url].title, r);
                                    }
                                    d && !o && m(i.url);
                                },
                                fetching: function () {
                ...
                return (
                    ...
                    null === e.history.state ? ((p = l.alterChangeState({ id: c }, n.title, g)), e.history.replaceState(p, n.title, g)) : (p = {}),
                    ...
                    R(u),
                    { href: g, cache: h, clear: m, load: w, fetch: y, restartCSSAnimations: x }
                );
            },
            c = function (e) {
                return this.each(function () {
                    var n = this.tagName.toLowerCase();
                    this.id && "body" !== n && "html" !== n && !t.data(this, "smoothState")
                        ? t.data(this, "smoothState", new u(this, e))
                        : !this.id && a
                        ? a.warn("Every smoothState container needs an id but the following one does not have one:", this)
                        : ("body" !== n && "html" !== n) || !a || a.warn("The smoothstate container cannot be the " + this.tagName + " tag");
                });
            };
